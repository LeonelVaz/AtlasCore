...
const RepositoryManager = ({ onBack }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribeToggled = eventBus.subscribe(
      "pluginSystem.repositoryToggled",
      ({ repositoryId, enabled }) => {
        setRepositories((prev) => ({ ...prev }));
      }
    );

    const unsubscribeSyncStarted = eventBus.subscribe(
    ...
    const unsubscribeSyncCompleted = eventBus.subscribe(
  ...
  const handleEditRepository = async () => {
    try {
      ...
      await pluginRepositoryManager.updateRepository(
        selectedRepository,
        editForm
      );
  ...
  const handleSyncAll = async () => {
    try {
      ...
      if (result.failed.length > 0) {
        setError(
          `No se pudieron sincronizar ${result.failed.length} repositorios`
        );
      }
    } catch (error) {
    ...
    <div className="repository-manager">
              ...
              >
                <div className="repository-info">
                  <div className="repository-header">
                    ...
                    {repository.official && (
                      <span className="repository-badge official-badge">
                        Oficial
                      </span>
                    )}
                  </div>
                ...
                <div className="repository-actions">
                  ...
                  <Button
                    onClick={() =>
                      handleToggleRepository(repository.id, !repository.enabled)
                    }
        ...
        <div className="add-repository-form">
          <div className="form-field">
            ...
            <input
              ...
              onChange={(e) =>
                setNewRepository({ ...newRepository, id: e.target.value })
              }
          ...
          <div className="form-field">
            ...
            <input
              ...
              onChange={(e) =>
                setNewRepository({ ...newRepository, name: e.target.value })
              }
          ...
          <div className="form-field">
            ...
            <input
              ...
              onChange={(e) =>
                setNewRepository({ ...newRepository, url: e.target.value })
              }
      ...
      >
        <div className="edit-repository-form">
          ...
          <div className="dialog-actions">
            ...
            <Button variant="primary" onClick={handleEditRepository}>
              Guardar
            </Button>
          </div>
        </div>
      ...
      >
        <div className="delete-repository-confirm">
          <p>¿Estás seguro de que deseas eliminar este repositorio?</p>
          <p className="warning-text">
            Esta acción no se puede deshacer. Los plugins instalados desde este
            repositorio no se verán afectados.
          </p>
