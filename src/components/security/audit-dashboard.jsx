...
const AuditDashboard = ({ onPluginClick, compact = false }) => {
  ...
  const handleExportAudit = async () => {
    try {
      ...
      a.href = url;
      a.download = `atlas-security-audit-${new Date()
        .toISOString()
        .slice(0, 10)}.json`;
        ...
        <>
          <div className="audit-summary">
            ...
            <div className="summary-card">
              ...
              <div className="summary-value">{auditByPlugin.length}</div>
            </div>
                  ...
                  <div key={index} className="type-bar">
                    ...
                    <div className="bar-container">
                      <div
                        ...
                        style={{
                          width: `${
                            (count / (auditStats.totalEntries || 1)) * 100
                          }%`,
                          backgroundColor: type.includes("security")
                            ? "#E53935"
            ...
            <div className="latest-header">
              ...
              {auditLogs.length > 10 && (
                <span
                  ...
                  onClick={() => alert("Ver todos los logs")}
                >
                  Ver todos
                </span>
              )}
                    ...
                    <div className="entry-details">
                      {log.pluginId ? (
                        <span>
                          Plugin:{" "}
                          <span
                            className="audit-plugin-link"
                            onClick={() =>
                              onPluginClick && onPluginClick(log.pluginId)
                            }
                          >
                            {log.pluginId}
                          </span>{" "}
