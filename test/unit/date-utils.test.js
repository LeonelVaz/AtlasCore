...
describe('Date Utils', () => {
  ...
  describe('formatDate', () => {
    test('formatea correctamente una fecha con opciones', () => {
      ...
      const monthYearFormatted = dateUtils.formatDate(mondayDate, monthYearOptions);
  ...
  describe('isTimeOverlapping', () => {
    test('detecta correctamente solapamientos de tiempo', () => {
      ...
      expect(dateUtils.isTimeOverlapping(start1, end1, start2, end2)).toBe(true);
      ...
      expect(dateUtils.isTimeOverlapping(start3, end3, start4, end4)).toBe(true);
      ...
      expect(dateUtils.isTimeOverlapping(start5, end5, start6, end6)).toBe(false);
      ...
      expect(dateUtils.isTimeOverlapping(start7, end7, start8, end8)).toBe(false);
    });
  });
