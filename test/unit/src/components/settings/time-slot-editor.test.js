...
const TimeSlotEditor = require('../../../../../src/components/settings/time-slot-editor').default;
...
describe('TimeSlotEditor Component', () => {
  ...
  test('debe renderizar el título y la descripción', () => {
    ...
    expect(screen.getByText('Franjas Horarias Personalizadas')).toBeInTheDocument();
    expect(screen.getByText(/Las franjas horarias personalizadas te permiten dividir/i)).toBeInTheDocument();
  });
  ...
  test('debe mostrar "Cargando..." si isLoading es true', () => {
    ...
    render(<TimeSlotEditor />);
    expect(screen.getByText('Cargando franjas horarias...')).toBeInTheDocument();
  });
  ...
  test('debe mostrar mensaje si no hay franjas personalizadas', () => {
    ...
    expect(screen.getByText(/No hay franjas horarias personalizadas\. Añade tu primera franja para comenzar\./i)).toBeInTheDocument();
