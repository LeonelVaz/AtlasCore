...
function StatusSelector(props) {
  const { currentMainStatus, currentSubStatus, currentStackableStatuses = [], onStatusChange, onCancel, styleProps } = props;
  ...
  return React.createElement(
    ...
    [
      ...
      React.createElement(React.Fragment, {key: 'stackable-status-section'}, [
        React.createElement('strong', {key: 'stackable-label', className: 'status-selector-label sub-label'}, 'Marcas Adicionales:'),
        React.createElement(
          'div',
          ...
          [
            React.createElement(
              'button',
              {
                ...
                onClick: () => handleStackableStatusToggle(VIDEO_STACKABLE_STATUS.QUESTION),
                className: `status-option-button ${currentStackableStatuses.includes(VIDEO_STACKABLE_STATUS.QUESTION) ? 'active' : ''}`
              },
