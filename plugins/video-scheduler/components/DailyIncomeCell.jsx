...
function DailyIncomeCell({ day, dailyIncomeData, onIncomeCellClick }) {
  ...
  if (incomeExists) {
    displayText = formatCurrency(
      dailyIncomeData.amount,
      dailyIncomeData.currency
    );
  ...
  return React.createElement(
    ...
    React.createElement("div", { className: "income-content-wrapper" }, [
      React.createElement(
        "div",
        { key: "income-amount-display", className: "income-amount-text" },
        displayText
      ),
      payerText &&
        React.createElement(
          "div",
          { key: "income-payer-display", className: "income-payer-text" },
          payerText
        ),
    ])
  );
